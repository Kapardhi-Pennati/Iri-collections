...
CATEGORIES = [
    {'name': 'Necklaces', 'description': 'Elegant necklaces and pendants for every occasion'},
    ...
    {'name': 'Rings', 'description': 'Stunning rings for engagement, wedding, and fashion'},
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not User.objects.filter(email='admin@iri.com').exists():
            ...
            self.stdout.write(self.style.SUCCESS(f'Created admin: admin@iri.com / Admin@123'))
        ...
        if not User.objects.filter(email='customer@test.com').exists():
            ...
            self.stdout.write(self.style.SUCCESS(f'Created customer: customer@test.com / Customer@123'))
